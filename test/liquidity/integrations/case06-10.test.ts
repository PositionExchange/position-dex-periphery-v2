...
describe("Integration-Case06-Case10", async function() {
    let testHelper: TestLiquidity

    beforeEach(async () => {
        testHelper = await deployAndCreateRouterHelper(10000)
    })
...
- S21: RemoveLiquidity
  ...
  Expect:
    ...
    User:
      Id: 1
      BalanceBase: 9990.24949
      BalanceQuote: 9688.96305
- S22: OpenMarket
  Action:
    Id: 3
    asset: base
...
- S24: RemoveLiquidity
  ...
  Expect:
    User:
      Id: 1
      BalanceBase: 9999.47794
      BalanceQuote: 9802.48097`
        )
    })
//     it("Case #7", async () => {
//         return testHelper.process(`
